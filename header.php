...
<html>
    ...
    <header class="site-header">
      <div class="container">
        ...
        <a href="<?php esc_url(site_url('/'));?>" class="js-search-trigger site-header__search-trigger"><i class="fa fa-search" aria-hidden="true"></i></a>
        <i class="site-header__menu-trigger fa fa-bars" aria-hidden="true"></i>
        <div class="site-header__menu group">
      <!-- if you want to make the navigate menu to be  controled from the
             word press admin, dynamic word press menu.
        -->  
          ...
          <div class="site-header__util">
            ...
            <a href="<?php esc_url(site_url('/'));?>" class="search-trigger js-search-trigger"><i class="fa fa-search" aria-hidden="true"></i></a>
          </div>
        </div>
      </div>
    </header> 
