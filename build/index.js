...
const instantSearch = new _modules_Search__WEBPACK_IMPORTED_MODULE_3__["default"](); // const googleMap = new GoogleMap()
...
class Search {
  ...
  } // genreating the th search result


  getResults() {
    // this.resultsDiv.html("Imagine real search results here...");
    // this.isSpinnerVisible = false;
    jquery__WEBPACK_IMPORTED_MODULE_0___default().when(jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + "/wp-json/wp/v2/posts?search=" + this.searchField.val()), jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + "/wp-json/wp/v2/pages?search=" + this.searchField.val()), jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + "/wp-json/wp/v2/event?search=" + this.searchField.val())).then((posts, pages, event) => {
